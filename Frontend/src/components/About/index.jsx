    ...
    >
      <div className="pagePadding">
        <div className="aboutTopContainer">
          ...
          <div className="aimsfor">
            <p className="paraSmall">
              ...
              software development ecosystem at NIT Calicut. Every student, in
              our opinion, has the capacity to succeed in the fast-paced field
              of software. Our goal is to give students the tools, direction,
              and encouragement they need to turn their potential into the
              abilities to pursue a career in software.
              <br />
              AlgoZenith aspires to empower NIT Calicut students to not only
              excel in the competitive world of software development but also
              become the future leaders and innovators in the field. We strongly
              believe that{" "}
        ...
        <div className=" gapBwSections">
          ...
          <div className="flex md:flex-row flex-col md:px-10 justify-center md:space-x-8">
            <div className="mt-5 flex">
              ...
              <div className="w-[320px]">
                ...
                <p className="paraSmall text-xs md:text-sm px-2">
                  ...
                  exercitationem reiciendis harum, fugiat consequatur illum!
                </p>
              </div>
            </div>
            <div className="mt-5 flex">
